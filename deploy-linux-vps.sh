#!/usr/bin/env bash
# ==========================================================
# DOMEX Report System - Automated Ubuntu/Linux VPS Setup Script
# ==========================================================
set -e

echo -e "\033[0;32m==========================================\033[0m"
echo -e "\033[0;32m   DOMEX Report System - Linux Setup      \033[0m"
echo -e "\033[0;32m==========================================\033[0m"

# 1. Ensure Root / Sudo
if [ "$EUID" -ne 0 ]; then
  echo -e "\033[0;31mPlease run this script as root or with sudo:\033[0m"
  echo "sudo bash -c \"\$(curl -fsSL https://raw.githubusercontent.com/devmadu08-boop/domex-reports/codex/linux-vps-deployment/deploy-linux-vps.sh)\""
  exit 1
fi
