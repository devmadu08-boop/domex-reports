...
export default function DateSelector({ selectedDate, onDateChange, searchDate, onSearchDateChange, onSearch }) {
  return (
    <div className="report-filter-card grid gap-4 p-4 md:grid-cols-[auto_1fr_auto_1fr_auto] md:items-end md:p-6">
      <span className="hidden h-16 w-16 place-items-center rounded-[22px] bg-[#fff8f4] text-violet-500 shadow-[8px_8px_18px_rgba(128,104,178,0.18),-8px_-8px_18px_rgba(255,255,255,0.9)] md:grid">
      ...
      <label className="grid gap-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-14 w-full rounded-[18px] border border-[#e5d8f4] bg-[#fff8f4] pl-14 pr-3 text-base font-black text-[#15143b] shadow-[inset_5px_5px_11px_rgba(128,104,178,0.13),inset_-5px_-5px_11px_rgba(255,255,255,0.9)] outline-none focus:border-violet-400 focus:ring-4 focus:ring-violet-100 md:pl-5"
          />
        </div>
