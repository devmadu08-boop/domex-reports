...
export default function PettyCashManagement({ selectedDate, branchName = "Middeniya", companyName = "Domestic Express (pvt) ltd", vehicleEmployeeMappings = [], floatAmount = 0, onSaveFloatAmount }) {
  ...
  return <section className="petty-cash-section grid min-w-0 gap-5">
    <div className="glass-panel petty-cash-workspace p-4 md:p-6">
      ...
      <section className="petty-float-panel mt-5">
